...
const EmoticaAI = () => {
  ...
  return (
    <div className="bg-gradient-to-b from-background/10 to-background bg-gray-900 flex items-center justify-center min-h-screen p-4 bg-gray-100 relative  pt-[100px]">
